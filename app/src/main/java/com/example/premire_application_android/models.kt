...
data class PersonDetailMovie(
    val cast: List<CastPersonMovie> = listOf(),
    val crew: List<Any> = listOf(),
    val id: String = ""
)

data class CastPersonMovie(
    val adult: Boolean,
    val backdrop_path: String,
    val character: String,
    val credit_id: String,
...
data class PersonDetailSerie(
    val cast: List<CastPersonSerie> = listOf(),
    val crew: List<Any> = listOf(),
    val id: String = ""
)

data class CastPersonSerie(
    val adult: Boolean,
    val backdrop_path: String,
    val character: String,
    val credit_id: String,
